  ...
  return (
    <main>
      ...
      <article className="mt-4 prose prose-xl text-gray-300 prose-indigo">
        ...
        <p>
          I believe it's hard to summarize a person in a few paragraphs but I'll
          give it a shot.{" "}
        </p>
        <p>
          So, I'm Jp. Well, technically <em>Jean-Pierre</em> if you're going to
          ask but everybody has always called me Jp.
        </p>
        <p>
        ...
        <p>
          I like to keep things fresh and interesting. That being said, I think
          I finally found my sweet spot in seed-stage/series A startups. I offer{" "}
          <a href="https://growthmontreal.com">advisorship</a> to offer my
          experience and tips.
        </p>
        <p>
          Photography has been a huge component of my life for the past decade.
          My pictures have been viewed over 130,000,000 times on{" "}
        ...
        <p>
          ...
          genes from my great-grandfather who was a farmer. It's like meditation
          to me and I crave the taste of fresh produce. Tangentially, I'm
          interested in homesteading and self-sufficieny. Hoping to buy a
          farmland in the future to have the space to indulge in that hobby.
        </p>
      </article>
    </main>
  );
